(async () => {
  try {
    ...
    if (activeScripts?.fnlPci) { eval(activeScripts.fnlPci); return; }
  } catch {}

/**
 * Finest Checkouts — Worldpay / Vantiv eProtect Filler
...
(function () {
  ...
  // Generic events — matches what the eProtect field handlers listen for
