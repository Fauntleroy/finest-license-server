/**
 * Finest Checkouts â€” AIO Generic Autofill
...
(function () {
  ...
  // â”€â”€â”€ One-shot version ping (rate-limited to 1/hour per browser) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  // Tells the server which extension version this user is currently running so
  // the admin dashboard can show who's up to date. Safe to run on every page â€”
  ...
  const naturalDelay = () => delay(20 + Math.random() * 30); // 20â€“50ms per field
