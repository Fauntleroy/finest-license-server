/**
 * Finest Checkouts â€” Waitwhile Auto-Booking
 * Full hands-free Supreme waitlist registration with auto-retry.
 *
 * Flow:
 *   1. /accounts/[business]        â†’ click preferred store
 *   2. /locations/[store]          â†’ click earliest time slot
 *   3. /locations/[store]/details  â†’ fill form + click "Schedule booking"
 *   4. /locations/[store]/closed   â†’ STOP (registration over)
 *   5. /visits/* or /status        â†’ STOP (booked successfully)
 *   On any error â†’ navigate back to /accounts/supremenewyork and retry.
 */
...
(function () {
  ...
  // â”€â”€â”€ Persistent overlay with Stop button â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  function setOverlay(message, color) {
    ...
    div.innerHTML = `
      <span style="flex:1">âš¡ Finest: ${message}</span>
    ...
    document.getElementById('finest-wwpp-stop').onclick = async () => {
      ...
      div.innerHTML = '<span style="color:#888">âš¡ Finest: Stopped. Toggle setting off/on to resume.</span>';
    };
  }
  ...
  // â”€â”€â”€ Detection helpers â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  // â”€â”€â”€ Restart back to account picker â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  async function restart(reason) {
    setOverlay(`${reason} â€” retrying...`, '#e8b04c');
  ...
  // â”€â”€â”€ Page handlers â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

  // /accounts/[business] â€” click the configured preferred store
  ...
  // /locations/[store] â€” click first (earliest) available time slot
  async function handleLocationPage() {
    ...
    // Confirm we moved on â€” if we stay on the location page with no progress
  ...
  // /locations/[store]/details â€” fill name/email/phone + submit
  async function handleDetailsPage(profile) {
    ...
    // Watch for outcome over the next 10s â€” success path or error message
    ...
    if (outcome === 'success') {
      setOverlay('Booking confirmed! âœ“', '#7ec98a');
    } else if (outcome === 'error') {
      await restart('Booking rejected');
    } else {
      // Timed out without clear outcome â€” restart to be safe
  ...
  function handleClosedPage() {
    ...
    // STOP â€” set stopped flag so we don't keep navigating
